...
function triggerCD(application, body, retry_cnt = 0) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const res = yield (0, node_fetch_1.default)(`${getBaseUrl()}/api/v1/applications/${application}/cd-trigger/`, {
            method: 'POST',
            headers: {
...
const cd_trigger_1 = __nccwpck_require__(4291);
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield (0, cd_trigger_1.triggerCD)(application, {
                profile,
                image_tag: imageTag,
                version,
